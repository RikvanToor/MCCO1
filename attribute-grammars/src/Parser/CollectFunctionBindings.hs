...
decls' (Declaration_FunctionBindings _ _:_) =
    error "CollectFunctionBindings decls not exactly one function binding in FunctionBindings"
...
functionBindingOfDeclaration _ = 
    error "CollectFunctionBindings getFunctionBinding unexpected declaration kind"
