module Types.Unification where

import Types.Substitution
import Types.Primitive
import Types.Synonym
...
mguWithTypeSynonyms typesynonyms = rec emptySubst
 ...
 where
   rec sub t1 t2 =
     case (leftSpine t1, leftSpine t2) of
        ...
        _ -> case (t1, t2) of
                ...
                _ ->  internalError "Types.Unification" "mguWithTypeSynonyms" "illegal type"
            ...
            case rec sub tp t2 of
               Right (True,sub') -> 
                  ...
                  in case mtp of 
                        ...
                        Nothing -> internalError "Types.Unification" "mguWithTypeSynonyms" "illegal types" 
               answer -> answer
         Nothing -> 
            case sub |-> tp of 
   ...
   recList _ _ _ = 
      internalError "Types.Unification" "mguWithTypeSynonyms" "kinds do not match"
