...
import Utils.Id(Id, idFromString, stringFromId)
import Data.Char
import Types
...
nameFromString _ = error "UHA_Utils nameFromString empty string"
...
stringFromImportDeclaration importDecl =
    case importDecl of
        ...
        ImportDeclaration_Empty _ -> 
            error "UHA_Utils stringFromImportDeclaration empty import declaration"
...
patternVars p = case p of
    ...
    _ -> error "UHA_Utils patternVars unsupported kind of pattern"
